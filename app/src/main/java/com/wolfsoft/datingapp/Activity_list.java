...
public class Activity_list extends AppCompatActivity {
    ...
    String txt[]={"activity_start_screen","activity_walkthrough","activity_sign_up","activity_login","activity_forgot_password","activity_home","activity_product_detail","activity_most_liked","activity_from_category","activity_promote","activity_details","activity_profile","activity_settings"};
